...
class BasicAgent(object):
    def __init__(self, config, use_GPU, gamma, eval_episodes, episode_num, replay_buffer_size, min_replay_size, batch_size) -> None:
        ...
        self.replay_buffer = Replay_Buffer(config.seed, replay_buffer_size, self.device)
